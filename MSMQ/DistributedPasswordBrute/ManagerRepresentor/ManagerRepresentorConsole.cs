...
namespace ManagerRepresentor
{
    class ManagerRepresentorConsole
    {
        static void Main()
        {
			...
			ManagerRepresentor managerRepresentor = new ManagerRepresentor("FormatName:Direct=TCP:192.168.43.233\\Private$\\RequestQueue", "FormatName:Direct=TCP:192.168.43.233\\Private$\\ReplyQueue");
            while (true)
            {
