...
#region SymbolFromRepresentation
        ...
        /// </summary>
        private void fillForUnnormal(char symbol)
        {
            char ch2;
        ...
        /// </summary>
        public char GetSum(char first, char second)
        {
            return _summTable[first][second];
        }
            
        private char[][] _summTable;
        private int[] _symbolBitRepresentation;
        private char[] _symbolFromBitRepresentation;
    }
